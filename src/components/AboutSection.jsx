...
const values = [
    {
        icon: "🌍",
        title: "Direct Trade Origins",
        description: "We partner with small farms in Ethiopa, Colombia, Guatemala, and Indonesia. Every bag is fully traceable to the farm it came from."
    },
    {
        icon: "☕",
        title: "Small-Batch Roasting",
        description: "Our master roaster profiles every bean to unlock its peak flavor. We roast in 25-lb batches for consistency and freshness you can tase."

    },
    {
        icon: "🚚",
        title: "Roast-To-Order Shipping",
        description: "We don't pre-roast and shelve. Your beans are roasted after you order and shipped within 1-2 business days. Free delivery on order over $50."
    }
];
...
<div className="about-content">
    ...
    <ScrollReveal animatio="fadeUp" delay={0.1}>
        <h1>
